  ...
  <div className="container">
    <div>
      <h1 className='whatsHappening'> About:</h1>
               <p>  Cool Shows Calendar DOT COM is a user generated community designed to give artists and fans
               ...
               <p> 
                  This app was built using React, Redux, PostgresSQL, Express, Passport, Material-UI, Node.JS, and the forum is powered by NodeBB.
              </p>
               <p>
